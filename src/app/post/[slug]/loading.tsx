export default function PostLoading() {
  return (
    <main className="flex-1 pb-28">
      {/* Cover skeleton */}
      <div className="w-full aspect-video bg-stone-200 animate-pulse" />
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 pt-6">
        ...
        {/* Excerpt */}
        <div className="h-5 w-full bg-stone-200 rounded animate-pulse mb-2" />
        <div className="h-5 w-5/6 bg-stone-200 rounded animate-pulse mb-8" />
        {/* Body paragraphs */}
